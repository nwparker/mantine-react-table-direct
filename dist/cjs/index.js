...
const MRT_RowPinButton = ({ pinningPosition, row, table, }) => {
    ...
    return (jsxRuntime.jsx(core.Tooltip, { opened: tooltipOpened, openDelay: 1000, label: isPinned ? localization.unpin : localization.pin, children: jsxRuntime.jsx(core.ActionIcon, { "aria-label": localization.pin, color: "gray", onClick: handleTogglePin, onMouseEnter: () => setTooltipOpened(true), onMouseLeave: () => setTooltipOpened(false), size: "xs", variant: "transparent", style: {
                height: '24px',
                width: '24px',
...
const MRT_TableBodyCell = ({ cell, isStriped, measureElement, numRows, rowIndex, rowRef, table, virtualCell, }) => {
    ...
    return (jsxRuntime.jsxs(core.TableTd, Object.assign({ "data-index": virtualCell === null || virtualCell === void 0 ? void 0 : virtualCell.index, ref: (node) => {
            if (node) {
...
const MRT_TableBodyRow = ({ columnVirtualizer, enableHover, isStriped, measureElement, numRows, row, rowIndex, table, pinnedRowIds, virtualColumns, virtualPaddingLeft, virtualPaddingRight, virtualRow, }) => {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsxs(core.TableTr, Object.assign({ "data-index": virtualRow === null || virtualRow === void 0 ? void 0 : virtualRow.index, "data-selected": row.getIsSelected() || undefined, onDragEnter: handleDragEnter, ref: (node) => {
                    if (node) {
                        rowRef.current = node;
                        measureElement === null || measureElement === void 0 ? void 0 : measureElement(node);
                    }
...
const MRT_TableBody = ({ columnVirtualizer, enableHover, isStriped, table, virtualColumns, virtualPaddingLeft, virtualPaddingRight, }) => {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [!(rowPinningDisplayMode === null || rowPinningDisplayMode === void 0 ? void 0 : rowPinningDisplayMode.includes('sticky')) &&
                ...
                }) }))), jsxRuntime.jsxs(core.TableTbody, Object.assign({}, tableBodyProps, { className: clsx(classes$y.root, (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith('grid')) && classes$y['root-grid'], !rows.length && classes$y['root-no-rows'], rowVirtualizer && classes$y['root-virtualized'], tableBodyProps === null || tableBodyProps === void 0 ? void 0 : tableBodyProps.className), __vars: Object.assign({ '--mrt-table-body-height': rowVirtualizer
                        ? `${rowVirtualizer.getTotalSize()}px`
                        : undefined }, tableBodyProps === null || tableBodyProps === void 0 ? void 0 : tableBodyProps.__vars), children: [creatingRow && createDisplayMode === 'row' && (jsxRuntime.jsx(MRT_TableBodyRow, { table: table, row: creatingRow, rowIndex: -1 })), !rows.length ? (jsxRuntime.jsx("tr", { className: clsx('mrt-table-body-row', (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith('grid')) && classes$y['empty-row-tr-grid']), children: jsxRuntime.jsx("td", { colSpan: table.getVisibleLeafColumns().length, className: clsx('mrt-table-body-cell', (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith('grid')) && classes$y['empty-row-td-grid']), children: (_c = renderEmptyRowsFallback === null || renderEmptyRowsFallback === void 0 ? void 0 : renderEmptyRowsFallback({ table })) !== null && _c !== void 0 ? _c : (jsxRuntime.jsx(core.Text, { className: clsx(classes$y['empty-row-td-content']), __vars: {
...
const MRT_GrabHandleButton = ({ actionIconProps, onDragEnd, onDragStart, table: { options: { icons: { IconGripHorizontal }, localization: { move }, }, }, }) => {
    ...
    return (jsxRuntime.jsx(core.Tooltip, { withinPortal: true, openDelay: 1000, label: (_a = actionIconProps === null || actionIconProps === void 0 ? void 0 : actionIconProps.title) !== null && _a !== void 0 ? _a : move, children: jsxRuntime.jsx(core.ActionIcon, Object.assign({ "aria-label": (_b = actionIconProps === null || actionIconProps === void 0 ? void 0 : actionIconProps.title) !== null && _b !== void 0 ? _b : move, draggable: true }, actionIconProps, { onClick: (e) => {
            ...
            }, onDragStart: onDragStart, onDragEnd: onDragEnd, className: clsx('mrt-grab-handle-button', classes$x['grab-icon'], actionIconProps === null || actionIconProps === void 0 ? void 0 : actionIconProps.className), title: undefined, children: jsxRuntime.jsx(IconGripHorizontal, {}) })) }));
};
...
const MRT_ExpandButton = ({ row, table, }) => {
    ...
    return (jsxRuntime.jsx(core.Tooltip, { withinPortal: true, disabled: !canExpand && !renderDetailPanel, openDelay: 1000, label: ((_a = actionIconProps === null || actionIconProps === void 0 ? void 0 : actionIconProps.title) !== null && _a !== void 0 ? _a : isExpanded)
            ...
            : localization.expand, children: jsxRuntime.jsx(core.ActionIcon, Object.assign({ "aria-label": localization.expand, color: "gray", disabled: !canExpand && !renderDetailPanel, variant: "transparent" }, actionIconProps, { onClick: handleToggleExpand, className: clsx('mrt-expand-button', classes$v.root, actionIconProps === null || actionIconProps === void 0 ? void 0 : actionIconProps.className), title: undefined, children: (_b = actionIconProps === null || actionIconProps === void 0 ? void 0 : actionIconProps.children) !== null && _b !== void 0 ? _b : (jsxRuntime.jsx(IconChevronDown, { className: clsx('mrt-expand-button-chevron', classes$v.chevron, !canExpand && !renderDetailPanel
                    ? classes$v.right
                    : isExpanded
                        ? classes$v.up
                        : undefined) })) })) }));
...
const MRT_RowActionMenu = ({ handleEdit, row, table, }) => {
    ...
    return (jsxRuntime.jsxs(core.Menu, { position: positionActionsColumn === 'first'
            ...
            : positionActionsColumn === 'last'
                ? 'bottom-end'
                : undefined, closeOnItemClick: true, withinPortal: true, children: [jsxRuntime.jsx(core.Tooltip, { withinPortal: true, openDelay: 1000, label: localization.rowActions, children: jsxRuntime.jsx(core.Menu.Target, { children: jsxRuntime.jsx(core.ActionIcon, { "aria-label": localization.rowActions, color: "gray", onClick: (event) => event.stopPropagation(), size: "sm", variant: "transparent", children: jsxRuntime.jsx(IconDots, {}) }) }) }), jsxRuntime.jsxs(core.Menu.Dropdown, { onClick: (event) => event.stopPropagation(), children: [enableEditing && editDisplayMode !== 'table' && (jsxRuntime.jsx(core.Menu.Item, { leftSection: jsxRuntime.jsx(IconEdit, {}), onClick: handleEdit, children: localization.edit })), renderRowActionMenuItems === null || renderRowActionMenuItems === void 0 ? void 0 : renderRowActionMenuItems({
                        row,
                        table,
                    })] })] }));
};
...
const SelectClearButton = ({ value, onChange, }) => {
    return value !== null ? (jsxRuntime.jsx(core.CloseButton, { size: "sm", onMouseDown: (event) => event.preventDefault(), onClick: () => onChange(null), "aria-label": "Clear value" })) : (jsxRuntime.jsx(core.Combobox.Chevron, {}));
};
const MRT_FilterTextInput = ({ header, rangeFilterIndex, table, }) => {
    ...
    const ClearButton = filterValue ? (jsxRuntime.jsx(core.ActionIcon, { "aria-label": localization.clearFilter, color: "gray", onClick: handleClear, size: "sm", title: (_e = localization.clearFilter) !== null && _e !== void 0 ? _e : '', variant: "transparent", children: jsxRuntime.jsx(IconX, {}) })) : null;
    return filterChipLabel ? (jsxRuntime.jsx(core.Box, { style: commonProps.style, children: jsxRuntime.jsx(core.Badge, { size: "lg", onClick: handleClearEmptyFilterChip, className: classes$o['filter-chip-badge'], rightSection: ClearButton, children: filterChipLabel }) })) : isMultiSelectFilter ? (jsxRuntime.jsx(core.MultiSelect, Object.assign({}, commonProps, { searchable: true }, multiSelectProps, { className: clsx(className, multiSelectProps.className), data: filterSelectOptions, ref: (node) => {
        ...
        }, style: commonProps.style, rightSection: jsxRuntime.jsx(SelectClearButton, { value: multiSelectProps.value, onChange: multiSelectProps.onChange }) }))) : isSelectFilter ? (jsxRuntime.jsx(core.Select, Object.assign({}, commonProps, { searchable: true }, selectProps, { className: clsx(className, selectProps.className), data: filterSelectOptions, ref: (node) => {
            if (node) {
                filterInputRefs.current[`${column.id}-${rangeFilterIndex !== null && rangeFilterIndex !== void 0 ? rangeFilterIndex : 0}`] =
                    node;
                if (selectProps.ref) {
...
const MRT_ShowHideColumnsMenuItems = ({ allColumns, hoveredColumn, setHoveredColumn, column, table, }) => {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(core.Menu.Item, Object.assign({ component: "span", ref: menuItemRef, __vars: {
                    '--_column-depth': core.rem(column.depth),
                    '--_hover-color': getPrimaryColor(theme),
                }, onDragEnter: handleDragEnter, className: classes$k.root }, dataVariable('dragging', isDragging), dataVariable('hovered', !isDragging && (hoveredColumn === null || hoveredColumn === void 0 ? void 0 : hoveredColumn.id) === column.id), { children: jsxRuntime.jsxs(core.Box, { className: classes$k.menu, children: [columnDefType !== 'group' &&
                            enableColumnOrdering &&
                            !allColumns.some((col) => col.columnDef.columnDefType === 'group') &&
                            (columnDef.enableColumnOrdering !== false ? (jsxRuntime.jsx(MRT_GrabHandleButton, { onDragEnd: handleDragEnd, onDragStart: handleDragStart, table: table })) : (jsxRuntime.jsx(core.Box, { className: classes$k.grab }))), enablePinning &&
...
const MRT_ToggleFiltersButton = (_a) => {
    ...
    return (jsxRuntime.jsx(core.Tooltip, { withinPortal: true, label: title !== null && title !== void 0 ? title : showHideFilters, children: jsxRuntime.jsx(core.ActionIcon, Object.assign({ size: "lg", variant: "default", "aria-label": title !== null && title !== void 0 ? title : showHideFilters, onClick: () => setShowColumnFilters((current) => !current) }, rest, { children: showColumnFilters ? jsxRuntime.jsx(IconFilterOff, {}) : jsxRuntime.jsx(IconFilter, {}) })) }));
};
...
const MRT_ToggleFullScreenButton = (_a) => {
    ...
    return (jsxRuntime.jsx(core.Tooltip, { opened: tooltipOpened, withinPortal: true, label: title !== null && title !== void 0 ? title : toggleFullScreen, children: jsxRuntime.jsx(core.ActionIcon, Object.assign({ size: "lg", variant: "default", "aria-label": title !== null && title !== void 0 ? title : toggleFullScreen, onClick: handleToggleFullScreen, onMouseEnter: () => setTooltipOpened(true), onMouseLeave: () => setTooltipOpened(false) }, rest, { children: isFullScreen ? jsxRuntime.jsx(IconMinimize, {}) : jsxRuntime.jsx(IconMaximize, {}) })) }));
};
...
const MRT_ToolbarInternalButtons = ({ table, }) => {
    ...
    return (jsxRuntime.jsx(core.Flex, { className: clsx('mrt-toolbar-internal-buttons', classes$i.root), children: (_a = renderToolbarInternalActions === null || renderToolbarInternalActions === void 0 ? void 0 : renderToolbarInternalActions({ table })) !== null && _a !== void 0 ? _a : (jsxRuntime.jsxs(core.ActionIcon.Group, { children: [enableFilters &&
                    enableGlobalFilter &&
...
const MRT_TableHeadCellFilterLabel = ({ header, table, }) => {
    ...
    return (jsxRuntime.jsxs(core.Popover, { onClose: () => setPopoverOpened(false), opened: popoverOpened, position: "top", keepMounted: columnDef.filterVariant === 'range-slider', shadow: "xl", width: 360, withinPortal: true, children: [jsxRuntime.jsx(core.Transition, { transition: "scale", mounted: columnFilterDisplayMode === 'popover' ||
                    ...
                    (isRangeFilter && // @ts-ignore
                        (!!((_b = column.getFilterValue()) === null || _b === void 0 ? void 0 : _b[0]) || !!((_c = column.getFilterValue()) === null || _c === void 0 ? void 0 : _c[1]))), children: () => (jsxRuntime.jsx(core.Box, { component: "span", children: jsxRuntime.jsx(core.Popover.Target, { children: jsxRuntime.jsx(core.Tooltip, { disabled: popoverOpened, label: filterTooltip, multiline: true, w: filterTooltip.length > 40 ? 300 : undefined, withinPortal: true, children: jsxRuntime.jsx(core.ActionIcon, { size: "sm", variant: "transparent", className: clsx('mrt-table-head-cell-filter-label-icon', classes$b.root, isFilterActive && classes$b.active), onClick: (event) => {
                                    event.stopPropagation();
...
const MRT_TableHeadCell = ({ header, table, }) => {
    ...
    return (jsxRuntime.jsxs(core.Box, Object.assign({}, tableCellProps, { component: "th", align: columnDefType === 'group' ? 'center' : 'left', colSpan: header.colSpan, onDragEnter: () => {
            if (enableGrouping && (hoveredColumn === null || hoveredColumn === void 0 ? void 0 : hoveredColumn.id) === 'drop-zone') {
                setHoveredColumn(null);
            }
...
const MRT_TableHead = ({ table, virtualColumns, virtualPaddingLeft, virtualPaddingRight, }) => {
    ...
    return (jsxRuntime.jsx(core.TableThead, Object.assign({}, tableHeadProps, { ref: (ref) => {
            ...
            (showAlertBanner || getSelectedRowModel().rows.length > 0) ? (jsxRuntime.jsx("tr", { className: clsx(classes$6['banner-tr'], (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith('grid')) && classes$6.grid), children: jsxRuntime.jsx("th", { colSpan: table.getVisibleLeafColumns().length, className: clsx(classes$6['banner-th'], (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith('grid')) && classes$6.grid), children: jsxRuntime.jsx(MRT_ToolbarAlertBanner, { table: table }) }) })) : (getHeaderGroups().map((headerGroup) => (jsxRuntime.jsx(MRT_TableHeadRow, { headerGroup: headerGroup, table: table, virtualColumns: virtualColumns, virtualPaddingLeft: virtualPaddingLeft, virtualPaddingRight: virtualPaddingRight }, headerGroup.id)))) })));
};
...
const MRT_TableFooter = ({ table, virtualColumns, virtualPaddingLeft, virtualPaddingRight, }) => {
    ...
    return (jsxRuntime.jsx(core.TableTfoot, Object.assign({}, tableFooterProps, tableFooterProps, { ref: (ref) => {
            tableFooterRef.current = ref;
            if (tableFooterProps === null || tableFooterProps === void 0 ? void 0 : tableFooterProps.ref) {
                // @ts-ignore
                tableFooterProps.ref.current = ref;
            }
        }, className: clsx(classes$3.root, tableFooterProps === null || tableFooterProps === void 0 ? void 0 : tableFooterProps.className, stickFooter && classes$3.sticky, (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith('grid')) && classes$3.grid), children: getFooterGroups().map((footerGroup) => (jsxRuntime.jsx(MRT_TableFooterRow, { footerGroup: footerGroup, table: table, virtualColumns: virtualColumns, virtualPaddingLeft: virtualPaddingLeft, virtualPaddingRight: virtualPaddingRight }, footerGroup.id))) })));
};
...
const MRT_Table = ({ table, }) => {
    ...
    return (jsxRuntime.jsxs(core.Table, Object.assign({ className: clsx('mrt-table', classes$2.root, (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith('grid')) && classes$2['root-grid'], enableColumnResizing &&
            layoutMode === 'semantic' &&
...
const MRT_TablePaper = ({ table, }) => {
    ...
    return (jsxRuntime.jsxs(core.Paper, Object.assign({ shadow: "xs", withBorder: true }, tablePaperProps, { className: clsx('mrt-table-paper', classes.root, tablePaperProps === null || tablePaperProps === void 0 ? void 0 : tablePaperProps.className), ref: (ref) => {
